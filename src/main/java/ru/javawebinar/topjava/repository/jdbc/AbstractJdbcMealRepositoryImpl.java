...
public abstract class AbstractJdbcMealRepositoryImpl<T> implements MealRepository {
    ...
    abstract T inToDataTime(LocalDateTime ltd);
    ...
    public Meal save(Meal meal, int userId) {
        MapSqlParameterSource map = new MapSqlParameterSource()
                ...
                .addValue("date_time", inToDataTime(meal.getDateTime()))
    ...
    public List<Meal> getBetween(LocalDateTime startDate, LocalDateTime endDate, int userId) {
        return jdbcTemplate.query(
                ...
                ROW_MAPPER, userId, inToDataTime(startDate), inToDataTime(endDate));
    }
}
